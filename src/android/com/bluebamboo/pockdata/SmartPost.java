package com.bluebamboo.pockdata;
...
public class SmartPost {
	...
	// Ӧ��ֻ��һ��ID,���Ա�ʶ���ĺϷ��ԣ���ֹ������
	// ��һ�����׹����У�EMV POSӦ���ж�ID��һ����
	private static byte[] id = new byte[] { 0, 0, 0, 0, 0, 1 }; // "000001";//6���ֽ�
	private static String business_en = ""; // �̻�Ӣ���� LLVAR60_2
	private static String business_zh = ""; // �̻������� LLVAR60
	private static String businessNo = "123456789012345"; // �̻��� AN15
	private static String terminalNo = "12345678"; // �ն˺� AN8
	...
	public static byte[] InitMessage(byte[] content) {
		...
		try {
			baos.write(PostDefine.START);
			baos.write(PostDefine.STX);
			int len = content.length + 8;//��path��type��id�ĳ��ȹ�8�ֽ�
			baos.write(Function.toHex2Len(len));
