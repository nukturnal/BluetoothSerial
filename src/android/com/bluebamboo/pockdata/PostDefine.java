...
public class PostDefine {
    ...
    public static byte PATH_2 = 0x02; // ������<- POS(����Ӧ����)
    public static byte PATH_3 = 0x03; // ������-��POS(����������)
    public static byte PATH_4 = 0x03; // ������<- POS(����Ӧ����)
    public static byte PATH_5 = 0x03; // ������<- POS(������������)
    public static byte PATH_6 = 0x03; // ������-> POS(����Ӧ����)

    public static byte TYPE_1 = 0x01; // ��������Ӧ��
    public static byte TYPE_2 = 0x02; // IC������
    public static byte TYPE_3 = 0x03; // ����Ӧ��

    public static byte REQUEST = 0x04; // ���ڽ�����������
    public static byte RESPONSE = 0x05; // ���ڽ�����������

    // public static string Id = "000001";//6���ֽ�
